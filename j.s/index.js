...
function displayMeal(meal) {
  ...
  <div class="justify-content-start d-flex">
					...
					<a class="btn youtube text-white ms-2" target="_blank" href="${meal.strYoutube}">Youtube
...
$(".nav-item a").click(async (e) => {
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						<input class="form-control shadow bg-light mb-4 text-dark rounded" onkeyup="validation()" id="name"
				...
				<div class="col-md-6">
					<div class="form-group">
						<input input class="form-control shadow bg-light text-dark rounded" onkeyup="validation()" class="form-control" id="email" placeholder="Enter Email">
				...
				<div class="col-md-6">
					<div class="form-group">
						<input input class="form-control shadow bg-light mb-4 text-dark rounded" onkeyup="validation()" class="form-control" id="phone" placeholder="Enter phone">
				...
				<div class="col-md-6">
					<div class="form-group">
						<input input class="form-control shadow bg-light text-dark rounded" onkeyup="validation()" class="form-control" id="age" placeholder="Enter Age">
				...
				<div class="col-md-6">
					<div class="form-group">
						<input input class="form-control shadow bg-light text-dark rounded" onkeyup="validation()" class="form-control" type="password" id="password"
				...
				<div class="col-md-6">
					<div class="form-group">
						<input input class="form-control shadow bg-light text-dark rounded" onkeyup="validation()" class="form-control" type="password" id="rePassword"
  ...
  document.querySelector(".toggel-menu").dispatchEvent(click_event);
...
function userPasswordValid() {
  return /^(?=.*\d)[A-Za-z\d@$!%*?&]{8,}$/.test(userPassword.value);
}
